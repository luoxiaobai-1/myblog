...
<div class="">
	...
	<div class="headImgBox" style="background-image: url(../../static/img/THUMB__4rii.jpg)">
		<div class="scene">
		...
		<div class="h-information">
			...
			<h2 class="h-description">
                        ...
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"追赶日月，不苟于山川"}}
...
export default {
	data() { //选项 / 数据
		return {
			...
			// path:'',//当前打开页面的路径
			input: '', //input输入内容
			headBg: 0,//'url(static/img/headbg0.jpg)', //头部背景图
			headTou: '', //头像
			projectList: '' //项目列表
		}
	},
